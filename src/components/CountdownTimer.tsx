...
interface CountdownTimerProps {
  ...
  nextBirthday?: string; // Format: "YYYY-MM-DD"
}

const CountdownTimer = ({
  relationshipStart = "2023-10-04",
  nextBirthday = "2025-08-20",
}: CountdownTimerProps) => {
  ...
  useEffect(() => {
    const updateCountdowns = () => {
      ...
      // Time since relationship started
  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-br from-dreamy/20 to-primary-soft/20">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16 animate-fade-in-up">
          <h2 className="text-5xl md:text-6xl font-dancing text-gradient-romantic mb-6">
            Our Time Together
          </h2>
